const doctors = [
  ...
  },
  {
    ...
    description: 'Expert in orthopedic surgery, specializing in joint replacement, sports injuries, and innovative treatment methodologies.',
  ...
  },
  {
    ...
    description: 'Dedicated dermatologist specializing in cosmetic and clinical dermatology, committed to enhancing skin health through personalized treatments.',
  ...
  },
  {
    ...
    description: 'Compassionate cardiologist with a focus on patient-centered care, specializing in heart disease prevention and advanced treatment.',
  ...
  },
  {
    ...
    description: 'Renowned neurologist with expertise in diagnosing and treating complex neurological disorders, with a focus on innovative therapies.',
  ...
  },
  {
    ...
    description: 'Leading orthopedic surgeon with expertise in sports injuries, trauma recovery, and joint replacement surgeries, utilizing the latest medical advancements.',
  ...
  },
  {
    ...
    description: 'Board-certified psychiatrist specializing in mental health, therapy, and medication management, committed to holistic patient care.',
